// ============================================
// PREX - SVG ICONS (कोई emoji नहीं)
// ============================================

const ICONS = {
  logo: `<svg viewBox="0 0 64 64" fill="none"><rect x="8" y="8" width="48" height="48" rx="14" fill="#6C5CE7"/><path d="M22 42V22h10c5 0 8 2.5 8 7s-3 7-8 7h-4v6h-6zm6-11h4c1.5 0 2.5-.8 2.5-2s-1-2-2.5-2h-4v4z" fill="#fff"/><circle cx="46" cy="46" r="6" fill="#00D9A3"/></svg>`,
  sparkle: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l1.8 5.2L19 9l-5.2 1.8L12 16l-1.8-5.2L5 9l5.2-1.8L12 2z"/><path d="M19 14l.9 2.6L22.5 17.5l-2.6.9L19 21l-.9-2.6L15.5 17.5l2.6-.9L19 14z" opacity="0.6"/></svg>`,
  ...
  guest: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/></svg>`,
