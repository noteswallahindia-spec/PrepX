/* ============================================
   PREX - SVG ICONS
   सब icons inline SVG (no emoji)
   ============================================ */

const ICONS = {
  logo: `<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="8" width="48" height="48" rx="14" fill="#6C5CE7"/>
    <path d="M22 42V22h10c5 0 8 2.5 8 7s-3 7-8 7h-4v6h-6zm6-11h4c1.5 0 2.5-.8 2.5-2s-1-2-2.5-2h-4v4z" fill="#fff"/>
    <circle cx="46" cy="46" r="6" fill="#00D9A3"/>
  </svg>`,
  ...
  guest: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  exam: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
